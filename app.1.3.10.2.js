...
async function saveCurrentWager(){
  ...
  captureWagerDraft();
  const gameSheetScroll=captureGameSheetScroll();
  ...
  state.saving=true;
  render();
  restoreGameSheetScroll(gameSheetScroll);
